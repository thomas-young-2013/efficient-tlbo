...
from tlbo.facade.two_stage_surrogate import TwoStageSurrogate
...
from tlbo.facade.owesome_surrogate import OwesomeSurrogate
from tlbo.facade.great_surrogate import GreatSurrogate
from tlbo.facade.nn_smfo_surrogate import NNSMFO
from tlbo.facade.random_surrogate import RandomSearch
from tlbo.facade.pogpe_surrogate import POGPESurrogate
...
def eval_algo(algo_id):
    ...
    for trial_id in range(args.num_rep):
        ...
        if algo_id == 0:
            ...
            print('tlbo-hpo without warm starting', trial_id)
            ts = create_surrogate()
        elif algo_id == 12:
            print('tlbo-hpo with warm starting', trial_id)
            ts = create_surrogate()
        elif algo_id == 11:
            # MKL-GP
            if args.benchmark == 'svm':
